...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        ...
        if tabuleiro["B"][1] == "":  ## or tabuleiro["A"][2] == "O" or tabuleiro["B"][0] == "O" or tabuleiro["B"][1] == "O" or tabuleiro["B"][2] == "O" or  tabuleiro["C"][0] == "O" or tabuleiro["C"][1] == "O" or tabuleiro["C"][2] == "O":
            tabuleiro["B"][1] = "X"
        else:
            tabuleiro["C"][0] = "X"
        ...
        if tabuleiro ["C"][0] == "X" and tabuleiro["B"][0] == "":
            tabuleiro["B"][0] = "X"
                  
        elif tabuleiro["B"][1] == "X" and tabuleiro["C"][2] == "":
            tabuleiro["C"][2] = "X"        
        
        elif tabuleiro["B"][1] == "X" and tabuleiro["C"][2] == "0" and tabuleiro["C"][0] == "O" and tabuleiro["C"][1] == "":
            tabuleiro["C"][1] = "X"
            
        elif tabuleiro["B"][1] == "X" and tabuleiro["C"][2] == "0" and tabuleiro["A"][2] == "O":
            tabuleiro["B"][2] = "X"
            
        elif tabuleiro["A"][2] == "" and tabuleiro["C"][2] =="O" and tabuleiro["C"][0] == "":
            tabuleiro["C"][0] = "X"
 
    
    
    elif jogada == 4:
        if tabuleiro["C"][2] == "O" and tabuleiro["C"][0]== "O" and tabuleiro["C"][1]== "":
            tabuleiro["C"][1] = "X"
        
        elif tabuleiro["C"][2] == "O" and tabuleiro["A"][2]== "O" and tabuleiro["B"][2]== "":
            tabuleiro["B"][2] = "X"
            
        elif tabuleiro["B"][2] == "X" and tabuleiro["B"][1] == "X" and tabuleiro["B"][0] == "":
            tabuleiro["B"][0] = "X"
        ...
        if tabuleiro["C"][0] == "X" and tabuleiro["C"][1] == "X" and tabuleiro["C"][3] == "":
            tabuleiro["C"][3] = "X"
            
        elif tabuleiro["A"][2] == "X" and tabuleiro["B"][2] == "X" and tabuleiro["C"][3] == "":
            tabuleiro["C"][3] = "X"
